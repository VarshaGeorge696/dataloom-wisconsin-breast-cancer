...
Logistic Regression training accuracy on the WDBC dataset.
"""
...
results_df.name = "logistic_regression_metrics"
...
algorithm_evaluation = dt_ae.algorithm_evaluation(
    label="Training accuracy evaluation of Logistic Regression",
    executes=dt_ae.software_method(
        label="models.logistic_regression.LogisticRegression.train",
        is_implemented_by="LogisticRegression.train(...)",
    ...
    evaluates=dt_ae.algorithm(label="Logistic Regression"),
...
instance = dt_da.data_analysis(
    label="Logistic Regression training accuracy statement",
    is_implemented_by="main_logistic_regression.py",
    has_part=algorithm_evaluation,
)

GENERATED_DIR = Path(__file__).resolve().parents[1] / "generated"
GENERATED_DIR.mkdir(parents=True, exist_ok=True)
output_file = GENERATED_DIR / "statement_05.json"
